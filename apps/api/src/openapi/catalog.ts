...
const ITEMS: readonly Operation[] = [
    ...
    { method: 'put', path: '/projects/:projectId/items/:id', tag: 'Tasks', summary: 'Change the name, priority or due date of a task', access: 'session', params: ProjectItemIdParams, body: UpdateItemBody, success: json(ItemDto), errors: [404] },
