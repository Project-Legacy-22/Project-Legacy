...
| [0018](0018-relais-par-boucle-de-trente-secondes.md) | Relais serverless par une boucle de trente secondes | Accepté | tout producteur d'événement sur la cible serverless |
