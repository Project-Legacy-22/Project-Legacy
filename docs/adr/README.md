...
| [0019](0019-migration-des-donnees-par-scripts-sql-relus.md) | Migration des données dans les deux sens par scripts SQL générés et relus | Accepté | la reprise du legacy, la sortie de Supabase, tout changement de schéma |
| [0020](0020-application-automatique-des-migrations-hebergees.md) | Application automatique des migrations à la base hébergée, migrations additives | Accepté | toute migration |
