...
const OWNERS: Readonly<Record<string, string>> = {
    ...
    'public.erase_account': '20260925120000_retention_purge',
    ...
    'public.purge_expired_data': '20260925120000_retention_purge',
    'public.record_item_created_notification': '20260915140000_notification_beyond_an_item',
    'public.record_invitation_notification': '20260924100000_project_invitations',
    ...
    'public.respond_to_invitation': '20260924100000_project_invitations',
    'public.set_item_assignees': '20260924140000_item_assignees',
...
describe('le registre des fonctions SQL', () => {
    ...
    it('couvre des fonctions reellement redefinies, sans quoi il ne protegerait rien', () => {
        ...
        expect(redefinies).toEqual([
            ...
            'public.record_item_created_notification',
        ]);
    });
});
